...
/**
  * @brief Devuelve los eventos de un año dado como argumento
  * @param anio año con el que se buscarán los eventos
  * @return Devuelve los eventos de ese año
  */

  Fecha_Historica getEventosAnio(int anio);
...
/**
  ...
  */
  ...
  void borrarEvento(string& event);
